// Generated by dart2js, the Dart to JavaScript compiler version: 1.16.0-dev.4.0.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    betaFunctionFactory: function(alpha, beta) {
      return new S.betaFunctionFactory_closure(alpha, beta);
    },
    betaDenominator: function(alpha, beta) {
      var interiorFunction, sum, u, u0, t1;
      interiorFunction = S.betaFunctionFactory(alpha, beta);
      for (sum = 0, u = 0; u < 1; u = u0) {
        u0 = u + 0.01;
        t1 = interiorFunction.call$1((u + u0) / 2);
        if (typeof t1 !== "number")
          return H.iae(t1);
        sum += (u0 - u) * t1;
      }
    ...
    linSpace: function(start, step, numPoints) {
      var points, count, i, epsilon, t1, t2;
      points = [];
      for (count = start, i = 0; i < numPoints; ++i) {
        points.push(count);
        count += step;
      }
      epsilon = step / 100;
    ...
    betaPDF: function(alpha, beta, xVals) {
      var points, denominator, numerator, t1, _i, x, t2;
      points = [];
      denominator = S.betaDenominator(alpha, beta);
      numerator = S.betaFunctionFactory(alpha, beta);
      if (denominator === 0)
        throw H.wrapException(P.Exception_Exception("Peak too narrow"));
      for (t1 = xVals.length, _i = 0; _i < xVals.length; xVals.length === t1 || (0, H.throwConcurrentModificationError)(xVals), ++_i) {
        x = xVals[_i];
        t2 = numerator.call$1(x);
        if (typeof t2 !== "number")
          return t2.$div();
        t2 = numerator.call$1(x);
        if (typeof t2 !== "number")
          return t2.$div();
        points.push(t2 / denominator);
      }
      return points;
    },
    makeCompleteGraph: function(numAgents) {
      var adjMatrix, i, j;
      adjMatrix = [];
      for (i = 0; i < numAgents; ++i) {
        ...
        for (j = 0; j < numAgents; ++j) {
          if (i >= adjMatrix.length)
            return H.ioore(adjMatrix, i);
          adjMatrix[i].push(1);
        }
      }
      return adjMatrix;
    },
    makeStarGraph: function(numAgents) {
      var adjMatrix, i, t1, j, t2, t3, t4;
      adjMatrix = [];
      for (i = 0; i < numAgents; ++i) {
        adjMatrix.push([]);
        for (t1 = i !== 0, j = 0; j < numAgents; ++j) {
          t2 = !t1 || i === j;
          t3 = adjMatrix[i];
          t4 = adjMatrix.length;
          if (t2) {
    ...
    betaFunctionFactory_closure: {
      "^": "Closure:2;alpha,beta",
      call$1: function(v) {
        var t1, t2, t3;
        t1 = J.$sub$n(this.alpha, 1);
        H.checkNum(v);
        H.checkNum(t1);
        t1 = Math.pow(v, t1);
        if (typeof v !== "number")
    ...
    Network: {
      "^": "Object;agents,machines,adjMatrix",
      getActs$0: function() {
        var acts, t1, t2, _i;
        acts = [];
        for (t1 = this.agents, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          acts.push(t1[_i].getMachineToPlay$0());
        return acts;
      },
      getPayouts$1: function(acts) {
        var payouts, i, t1, t2;
        payouts = [];
        for (i = 0; i < acts.length; ++i) {
          ...
          if (t2 >= 2)
            return H.ioore(t1, t2);
          payouts.push(t1[t2].pull$0());
        }
        return payouts;
      },
      step$2: function(_, acts, payouts) {
        var i, j, t1, t2, t3, t4, t5;
          ...
          while (true) {
            ...
            if (t1[j] === 1)
              if (j !== 0) {
                ...
                t1 = t1[i];
                if (j >= acts.length)
                  return H.ioore(acts, j);
                t2 = acts[j];
                if (j >= payouts.length)
                  return H.ioore(payouts, j);
                t3 = payouts[j];
                t4 = t1.alphas;
                if (t2 >= t4.length)
                  return H.ioore(t4, t2);
                t5 = J.$add$ns(t4[t2], t3);
                if (t2 >= t4.length)
                  return H.ioore(t4, t2);
                t4[t2] = t5;
                t1 = t1.betas;
    ...
    BetaAgent: {
      ...
      reset$0: function(_) {
        var i, t1, t2, t3;
        for (i = 0; t1 = this.alphas, i < t1.length; ++i) {
          t2 = $.$get$BetaAgent_rGen();
          t3 = t2.nextDouble$0();
          if (i >= t1.length)
            return H.ioore(t1, i);
          t1[i] = 4 * t3;
      ...
      resetFromInterval$2: function(alphaBounds, betaBounds) {
        var i, t1, t2, t3, t4;
        for (i = 0; t1 = this.alphas, i < t1.length; ++i) {
          t2 = alphaBounds[0];
          t3 = alphaBounds[1];
          t4 = $.$get$BetaAgent_rGen();
          t3 = J.$add$ns(t2, J.$mul$ns(t3, t4.nextDouble$0()));
          if (i >= t1.length)
            return H.ioore(t1, i);
          t1[i] = t3;
          t3 = this.betas;
          t4 = J.$add$ns(betaBounds[0], J.$mul$ns(betaBounds[1], t4.nextDouble$0()));
          if (i >= 2)
            return H.ioore(t3, i);
          t3[i] = t4;
        }
      },
      getMachineToPlay$0: function() {
        var t1, t2, t3, t4;
        t1 = this.alphas;
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        t1 = t1[0];
        t2 = J.$add$ns(t1, this.betas[0]);
        if (typeof t1 !== "number")
          return t1.$div();
        if (typeof t2 !== "number")
          return H.iae(t2);
    ...
    Machine: {
      ...
      pull$0: function() {
        var r, t1;
        r = $.$get$Machine_rGen().nextDouble$0();
        t1 = this.p;
        if (typeof t1 !== "number")
          return H.iae(t1);
        if (r < t1)
    ...
    max: [function(a, b) {
      ...
      if (b === 0 && C.JSNumber_methods.get$isNegative(a))
        return b;
      return a;
    }, "call$2", "math__max$closure", 4, 0, 14],
    ...
    }, "call$1", "intl_Intl__throwLocaleError$closure", 2, 0, 15],
    ...
    NumberFormat: {
      "^": "Object;_negativePrefix,_positivePrefix,_negativeSuffix,_positiveSuffix,_groupingSize,_finalGroupingSize,_groupingSizeSetExplicitly,_decimalSeparatorAlwaysShown,_useSignForPositiveExponent,_useExponentialNotation,maximumIntegerDigits,minimumIntegerDigits,maximumFractionDigits,minimumFractionDigits,minimumExponentDigits,_internalMultiplier,_multiplierDigits,_intl$_pattern,_locale,_symbols,currencyName,_currencySymbol,_decimalDigits,_buffer,_maxInt,_zero",
      ...
      _floor$1: function(number) {
        ...
        return typeof number === "number" ? C.JSNumber_methods.toInt$0(Math.floor(number)) : t1.$tdiv(number, 1);
      },
      _round$1: function(number) {
        var basic, fraction;
        if (typeof number === "number")
          return C.JSNumber_methods.round$0(number);
        else if (J.remainder$1$n(number, 1) === 0)
          return number;
        else {
          basic = this._floor$1(number);
          if (typeof basic !== "number")
            return H.iae(basic);
          fraction = C.JSNumber_methods.round$0(number - basic);
      ...
      _formatFixed$1: function(number) {
        ...
        if (t1) {
          ...
          remainingDigits = C.JSNumber_methods.toInt$0(this._round$1(J.$mul$ns(t2.$sub(number, integerPart), digitMultiplier)));
        ...
        if (digitLength !== 0 || this.minimumIntegerDigits > 0) {
          ...
          for (t1 = this._buffer, t2 = this._zero, i = 0; i < digitLength; ++i) {
      ...
      _formatFractionPart$1: function(fractionPart) {
        ...
        for (t2 = this._buffer, i = 1; i < fractionLength; ++i) {
      ...
      _setPattern$1: function(newPattern) {
        ...
        t3.moveNext$0();
        new T._NumberFormatParser(this, t3, t1, t2, false, -1, 0, 0, 0, -1).parse$0();
        if (this.currencyName !== this._symbols.DEF_CURRENCY_CODE) {
          t1 = $.$get$currencyFractionDigits();
          t2 = t1.$index(0, this.currencyName.toUpperCase());
          digits = t2 == null ? t1.$index(0, "DEFAULT") : t2;
      ...
      static: {
        NumberFormat_NumberFormat: function(newPattern, locale) {
          ...
          t2 = new T.NumberFormat("-", "", "", "", 3, 3, false, false, false, false, 40, 1, 3, 0, 0, 1, 0, null, t3, null, null, null, null, new P.StringBuffer(""), t1, t2);
          t2._currencySymbol = null;
          t2._decimalDigits = null;
          t3 = $.numberFormatSymbols.$index(0, t3);
          t2._symbols = t3;
          t2.currencyName = t3.DEF_CURRENCY_CODE;
          t2._setPattern$1(new T.closure(newPattern).call$1(t3));
          return t2;
        },
        ...
        }, "call$1", "intl_NumberFormat_localeExists$closure", 2, 0, 16]
      }
    },
    closure: {
      "^": "Closure:2;newPattern",
      call$1: function(x) {
    ...
    "^": "",
    main: [function() {
      var t1, t2, i, graph, t3;
      t1 = new S.Machine(null);
      t1.p = 0.5;
      t2 = new S.Machine(null);
      t2.p = 0.51;
      $.machines = [t1, t2];
      $.agents = [];
      for (i = 0; t1 = $.numAgents, i < t1; ++i) {
        t1 = $.agents;
        t2 = new S.BetaAgent(null, null);
        t2.alphas = [1, 1];
        t2.betas = [1, 1];
        t2.reset$0(0);
        t1.push(t2);
      }
      graph = S.makeStarGraph(t1);
      t1 = $.agents;
      t2 = $.machines;
      t3 = new S.Network(null, null, null);
      t3.agents = t1;
      t3.machines = t2;
      t3.adjMatrix = graph;
      $.network = t3;
      F.paintNetwork(true);
      F.updateDisplay();
      t3 = document.querySelector("#stepButton");
      $.stepButton = t3;
      t3 = J.get$onClick$x(t3);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(F.main__stepButtonClicked$closure()), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = J.get$onClick$x(document.querySelector("#resetButton"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(F.main__resetButtonClicked$closure()), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = J.get$onClick$x(document.querySelector("#star_radio"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(F.main__switchToStar$closure()), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = J.get$onClick$x(document.querySelector("#complete_radio"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(F.main__switchToComplete$closure()), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = J.get$onInput$x(document.querySelector("#red_arm_p"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(F.main__changeMachine0$closure()), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = J.get$onInput$x(document.querySelector("#blue_arm_p"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(F.main__changeMachine1$closure()), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    }, "call$0", "main__main$closure", 0, 0, 1],
    changeMachine0: [function(e) {
      var p, ex, exception, t1, t2;
      p = 0.5;
      try {
        p = H.Primitives_parseDouble(J.get$value$x(J.get$target$x(e)), null);
      } catch (exception) {
        t1 = H.unwrapException(exception);
        ex = t1;
        P.print(ex);
      ...
      t2.p = p;
      t1[0] = t2;
    }, "call$1", "main__changeMachine0$closure", 2, 0, 3],
    changeMachine1: [function(e) {
      var p, ex, exception, t1, t2;
      p = 0.51;
      try {
        p = H.Primitives_parseDouble(J.get$value$x(J.get$target$x(e)), null);
      ...
      t2.p = p;
      t1[1] = t2;
    }, "call$1", "main__changeMachine1$closure", 2, 0, 3],
    switchToStar: [function(e) {
      var starGraph = S.makeStarGraph($.numAgents);
      $.network.adjMatrix = starGraph;
      F.paintNetwork(true);
    }, "call$1", "main__switchToStar$closure", 2, 0, 3],
    switchToComplete: [function(e) {
      var completeGraph = S.makeCompleteGraph($.numAgents);
      $.network.adjMatrix = completeGraph;
      F.paintNetwork(false);
    }, "call$1", "main__switchToComplete$closure", 2, 0, 3],
    resetButtonClicked: [function(e) {
      var alpha, beta, t1, t2, _i;
      alpha = [0, 4];
      beta = [0, 4];
      alpha[0] = H.Primitives_parseDouble(J.get$value$x(document.querySelector("#alpha_lower_text")), null);
      alpha[1] = H.Primitives_parseDouble(J.get$value$x(document.querySelector("#alpha_upper_text")), null);
      beta[0] = H.Primitives_parseDouble(J.get$value$x(document.querySelector("#beta_lower_text")), null);
      beta[1] = H.Primitives_parseDouble(J.get$value$x(document.querySelector("#beta_upper_text")), null);
      for (t1 = $.agents, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
        t1[_i].resetFromInterval$2(alpha, beta);
      F.updateDisplay();
    }, "call$1", "main__resetButtonClicked$closure", 2, 0, 3],
    stepButtonClicked: [function(e) {
      var acts, payouts;
      acts = $.network.getActs$0();
      payouts = $.network.getPayouts$1(acts);
      $.network.step$2(0, acts, payouts);
      F.updateDisplay();
    }, "call$1", "main__stepButtonClicked$closure", 2, 0, 3],
    updateDisplay: function() {
      F.updateDisplayForAgent(0);
      F.updateDisplayForAgent(1);
      F.updateDisplayForAgent(2);
      F.updateDisplayForAgent(3);
      F.updateDisplayForAgent(4);
    },
    updateDisplayForAgent: function(index) {
      var selectString, exps, arm, t1, t2, t3, svgAgent;
      selectString = "#agent" + C.JSInt_methods.toString$0(index);
      exps = [0, 0];
      for (arm = 0; arm < 2; ++arm) {
        t1 = selectString + "Alpha" + C.JSInt_methods.toString$0(arm);
        ...
        t3 = t3[index].alphas;
        if (arm >= t3.length)
          return H.ioore(t3, arm);
        t1.textContent = t2.format$1(t3[arm]);
        t3 = selectString + "Beta" + C.JSInt_methods.toString$0(arm);
        t3 = document.querySelector(t3);
        t2 = $.$get$nfAlphaBeta();
        t1 = $.agents;
        if (index >= t1.length)
          return H.ioore(t1, index);
        t3.textContent = t2.format$1(t1[index].betas[arm]);
        t1 = $.agents;
        if (index >= t1.length)
          return H.ioore(t1, index);
        t1 = t1[index];
        t2 = t1.alphas;
        if (arm >= t2.length)
          return H.ioore(t2, arm);
        t2 = t2[arm];
        t1 = J.$add$ns(t2, t1.betas[arm]);
        if (typeof t2 !== "number")
          return t2.$div();
        if (typeof t1 !== "number")
          return H.iae(t1);
        exps[arm] = t2 / t1;
        t1 = selectString + "Exp" + C.JSInt_methods.toString$0(arm);
        document.querySelector(t1).textContent = $.$get$nfExp().format$1(exps[arm]);
      }
      if (exps[1] > exps[0]) {
        t1 = $.machines;
        t1 = J.$gt$n(t1[1].p, t1[0].p);
      } else
        t1 = false;
      if (t1) {
        t1 = selectString + "Correct";
        document.querySelector(t1).textContent = "Correctly believes Blue is best";
      } else {
        if (exps[1] > exps[0]) {
          t1 = $.machines;
          t1 = J.$gt$n(t1[0].p, t1[1].p);
        } else
          t1 = false;
        if (t1) {
          t1 = selectString + "Correct";
          document.querySelector(t1).textContent = "Incorrectly believes Blue is best";
        } else {
          if (exps[1] < exps[0]) {
            t1 = $.machines;
            t1 = J.$gt$n(t1[0].p, t1[1].p);
          ...
          if (t1) {
            t1 = selectString + "Correct";
            document.querySelector(t1).textContent = "Correctly believes Red is best";
          } else {
            t1 = $.machines;
            if (J.$eq$(t1[0].p, t1[1].p)) {
              t1 = selectString + "Correct";
              document.querySelector(t1).textContent = "Both arms are equally good";
            } else {
              t1 = selectString + "Correct";
              document.querySelector(t1).textContent = "Incorrectly believes Red is best";
            }
          }
        }
      }
      t1 = selectString + "svg";
      svgAgent = document.querySelector(t1);
      t1 = $.agents;
      if (index >= t1.length)
        return H.ioore(t1, index);
      F.plotBetaPDFs(svgAgent, t1[index]);
    },
    plotBetaPDFs: function(svgE, agent) {
      var xVals, yVals0, yVals1, e, t1, exception, t2, t3, pRangeY, scaleY;
      t1 = $.agents;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0].alphas;
      ...
      try {
        ...
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        yVals0 = S.betaPDF(t1[0], agent.get$betas()[0], xVals);
        t1 = agent.get$alphas();
        if (1 >= t1.length)
          return H.ioore(t1, 1);
        yVals1 = S.betaPDF(t1[1], agent.get$betas()[1], xVals);
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
        P.print(e);
      ...
      D.getPlotRangeY(yVals0, yVals1)[1];
      t1 = xVals;
      t2 = yVals0;
      t3 = yVals1;
      svgE.clientWidth;
      pRangeY = D.getPlotRangeY(t2, t3);
      scaleY = 1 / pRangeY[1];
      J.get$children$x(svgE).clear$0(0);
      D.drawAxes(svgE, [[0, 1], pRangeY]);
      D.plotConnectedPoints(svgE, t1, t2, [1, scaleY], "stroke:rgb(255,0,0);stroke-width:2");
      D.plotConnectedPoints(svgE, t1, t3, [1, scaleY], "stroke:rgb(0,0,255);stroke-width:2");
    },
    paintNetwork: function(isStar) {
      var svgE, t1, p, q, d, t2, temp;
      svgE = document.querySelector("#network_svg");
      t1 = J.getInterceptor$x(svgE);
      t1.get$children(svgE).clear$0(0);
      F.addNetworkLine(svgE, 0, 1, "fill:none;stroke:rgb(100,100,100);stroke-width:3");
      F.addNetworkLine(svgE, 0, 2, "fill:none;stroke:rgb(100,100,100);stroke-width:3");
      F.addNetworkLine(svgE, 0, 3, "fill:none;stroke:rgb(100,100,100);stroke-width:3");
      F.addNetworkLine(svgE, 0, 4, "fill:none;stroke:rgb(100,100,100);stroke-width:3");
      if (!isStar) {
        p = F.agentToNetworkCanvas(1);
        q = F.agentToNetworkCanvas(2);
        d = "M " + p[0] + "," + p[1] + "A 315 600 0 0 1 " + q[0] + "," + q[1];
        t2 = document;
        temp = t2.createElementNS("http://www.w3.org/2000/svg", "path");
        temp.setAttribute("d", d);
        temp.setAttribute("style", "fill:none;stroke:rgb(100,100,100);stroke-width:3");
        t1.get$children(svgE).add$1(0, temp);
        q = F.agentToNetworkCanvas(3);
        ...
        temp.setAttribute("style", "fill:none;stroke:rgb(100,100,100);stroke-width:3");
        t1.get$children(svgE).add$1(0, temp);
        p = F.agentToNetworkCanvas(2);
        q = F.agentToNetworkCanvas(3);
        d = "M " + p[0] + "," + p[1] + "A 315 400 0 0 1 " + q[0] + "," + q[1];
        t2 = document;
        temp = t2.createElementNS("http://www.w3.org/2000/svg", "path");
        temp.setAttribute("d", d);
        temp.setAttribute("style", "fill:none;stroke:rgb(100,100,100);stroke-width:3");
    ...
    addNetworkLine: function(svgE, i, j, styleString) {
      var p, q, t1, temp;
      p = F.agentToNetworkCanvas(i);
      q = F.agentToNetworkCanvas(j);
      t1 = document;
      temp = t1.createElementNS("http://www.w3.org/2000/svg", "line");
      temp.setAttribute("x1", p[0]);
      temp.setAttribute("y1", p[1]);
      temp.setAttribute("x2", q[0]);
      temp.setAttribute("y2", q[1]);
      temp.setAttribute("style", styleString);
      J.get$children$x(svgE).add$1(0, temp);
    },
    agentToNetworkCanvas: function(index) {
      if (index === 0)
        return ["770", "0"];
      return [C.JSInt_methods.toString$0(143 + (index - 1) * 315), C.JSInt_methods.toString$0(100)];
    }
  }, 1], ["number_symbol_data", "package:intl/number_symbols_data.dart",, F, {
    "^": ""
    ...
    "^": "",
    getPlotRangeY: function(yVals0, yVals1) {
      var m, t1, exception;
      m = P.max((yVals0 && C.JSArray_methods).reduce$1(yVals0, P.math__max$closure()), (yVals1 && C.JSArray_methods).reduce$1(yVals1, P.math__max$closure()));
      if (J.$gt$n(m, 20))
        return [0, 20];
      try {
        t1 = C.JSNumber_methods.toInt$0(Math.ceil(m));
        return [0, t1];
      } catch (exception) {
        H.unwrapException(exception);
        return [0, 20];
    ...
    plotConnectedPoints: function(svgE, xVals, yVals, scale, style) {
      var i, t1, t2, t3, t4, t5, t6;
      for (i = 0; i < xVals.length - 1;) {
        t1 = scale[0];
        t2 = xVals[i];
        t3 = scale[1];
        t4 = yVals.length;
        if (i >= t4)
          return H.ioore(yVals, i);
        t5 = yVals[i];
        ++i;
        t6 = xVals[i];
        if (i >= t4)
          return H.ioore(yVals, i);
        D.addLine(svgE, [t1 * t2, t3 * t5], [t1 * t6, t3 * yVals[i]], style);
      }
    },
    drawAxes: function(svgE, plotRange) {
      var height, width, t1, pRangeX, pRangeY, thick, step, x, p, t2, t3;
      height = svgE.clientHeight;
      width = svgE.clientWidth;
      t1 = $.$get$axisOffsetY();
      ...
      if (typeof width !== "number")
        return width.$sub();
      pRangeX = [C.JSNumber_methods.toInt$0(Math.floor(plotRange[0][0])), C.JSNumber_methods.toInt$0(Math.floor(plotRange[0][1]))];
      pRangeY = [C.JSNumber_methods.toInt$0(Math.floor(plotRange[1][0])), C.JSNumber_methods.toInt$0(Math.floor(plotRange[1][1]))];
      thick = "stroke:rgb(0,0,0);stroke-width:" + C.JSInt_methods.toString$0($.axisWidth);
      D.addLine(svgE, [0, 0], [1, 0], thick);
      D.addLine(svgE, [0, 0], [0, 1], thick);
      D.addLine(svgE, [0.25, 0], [0.25, 1], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [0.5, 0], [0.5, 1], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [0.75, 0], [0.75, 1], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [1, 0], [1, 1], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [0, 0.25], [1, 0.25], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [0, 0.5], [1, 0.5], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [0, 0.75], [1, 0.75], "stroke:rgb(169,169,169);stroke-width:1");
      D.addLine(svgE, [0, 1], [1, 1], "stroke:rgb(169,169,169);stroke-width:1");
      step = (pRangeX[1] - pRangeX[0]) / 4;
      for (x = 0; x <= 1; x += 0.25) {
        t1 = pRangeX[0];
        height = svgE.clientHeight;
        p = D.pointToCanvas([x, 0], svgE.clientWidth, height);
        t2 = p[1];
        t3 = $.$get$axisOffsetY();
        if (typeof t3 !== "number")
          return H.iae(t3);
        p[1] = t2 + t3;
        D.addTextAbsolute(svgE, p, C.JSNumber_methods.toString$0(t1 + x * 4 * step));
      }
      step = (pRangeY[1] - pRangeY[0]) / 4;
      for (x = 0; x <= 1; x += 0.25) {
        t1 = pRangeY[0] + x * 4 * step;
        height = svgE.clientHeight;
        p = D.pointToCanvas([0, x], svgE.clientWidth, height);
        p[0] = p[0] - ($.axisOffsetX - 9);
        p[1] = p[1] + 5;
        C.JSNumber_methods.toString$0(t1);
        D.addTextAbsolute(svgE, p, t1 < 1 ? $.$get$nf0().format$1(t1) : $.$get$nf1().format$1(t1));
      }
    },
    addTextAbsolute: function(svgE, p, s) {
      var t1, temp;
      t1 = document;
      temp = t1.createElementNS("http://www.w3.org/2000/svg", "text");
      temp.setAttribute("text-anchor", "middle");
      temp.setAttribute("x", C.JSNumber_methods.toString$0(p[0]));
      temp.setAttribute("y", C.JSNumber_methods.toString$0(p[1]));
      temp.appendChild(document.createTextNode(s));
      J.get$children$x(svgE).add$1(0, temp);
    },
    addLine: function(svgE, p0, p1, styleString) {
      var height, width, t1, temp;
      height = svgE.clientHeight;
      width = svgE.clientWidth;
      p0 = D.pointToCanvas(p0, width, height);
      p1 = D.pointToCanvas(p1, width, height);
      t1 = document;
      temp = t1.createElementNS("http://www.w3.org/2000/svg", "line");
      temp.setAttribute("x1", C.JSNumber_methods.toString$0(p0[0]));
      temp.setAttribute("y1", C.JSNumber_methods.toString$0(p0[1]));
      temp.setAttribute("x2", C.JSNumber_methods.toString$0(p1[0]));
      temp.setAttribute("y2", C.JSNumber_methods.toString$0(p1[1]));
      temp.setAttribute("style", styleString);
      J.get$children$x(svgE).add$1(0, temp);
    },
    pointToCanvas: function(point, width, height) {
      var t1, t2, t3, t4;
      t1 = $.axisOffsetX;
      t2 = $.axisWidth;
      t3 = point[0];
      ...
      if (typeof t4 !== "number")
        return H.iae(t4);
      return [t1 + t2 + t3 * (width - 2 * t1 - t2), height - t4 - t2 - point[1] * (height - t4 - 5 - t2)];
    }
  }]];
  setupProgram(dart, 0);
...
;
  ...
  C.List_gMT = Isolate.makeConstantList(["af", "am", "ar", "az", "be", "bg", "bn", "br", "bs", "ca", "chr", "cs", "cy", "da", "de", "de_AT", "de_CH", "el", "en", "en_AU", "en_CA", "en_GB", "en_IE", "en_IN", "en_SG", "en_US", "en_ZA", "es", "es_419", "es_ES", "es_MX", "es_US", "et", "eu", "fa", "fi", "fil", "fr", "fr_CA", "ga", "gl", "gsw", "gu", "haw", "he", "hi", "hr", "hu", "hy", "id", "in", "is", "it", "iw", "ja", "ka", "kk", "km", "kn", "ko", "ky", "ln", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "ms", "mt", "my", "nb", "ne", "nl", "no", "no_NO", "or", "pa", "pl", "pt", "pt_BR", "pt_PT", "ro", "ru", "si", "sk", "sl", "sq", "sr", "sr_Latn", "sv", "sw", "ta", "te", "th", "tl", "tr", "uk", "ur", "uz", "vi", "zh", "zh_CN", "zh_HK", "zh_TW", "zu"]);
  C.NumberSymbols_w0x = new B.NumberSymbols("af", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "ZAR");
  C.NumberSymbols_TV6 = new B.NumberSymbols("am", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "ETB");
  C.NumberSymbols_xU4 = new B.NumberSymbols("ar", "\u066b", "\u066c", "\u066a", "\u0660", "\u200f+", "\u200f-", "\u0627\u0633", "\u0609", "\u221e", "\u0644\u064a\u0633\xa0\u0631\u0642\u0645", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "EGP");
  C.NumberSymbols_WjS = new B.NumberSymbols("az", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "AZN");
  C.NumberSymbols_zrt = new B.NumberSymbols("be", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "BYR");
  C.NumberSymbols_zDH = new B.NumberSymbols("bg", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "BGN");
  C.NumberSymbols_Erq = new B.NumberSymbols("bn", ".", ",", "%", "\u09e6", "+", "-", "E", "\u2030", "\u221e", "\u09b8\u0982\u0996\u09cd\u09af\u09be\xa0\u09a8\u09be", "#,##,##0.###", "#E0", "#,##,##0%", "#,##,##0.00\xa4", "BDT");
  C.NumberSymbols_YfA = new B.NumberSymbols("br", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_6Hv = new B.NumberSymbols("bs", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "BAM");
  C.NumberSymbols_4QF = new B.NumberSymbols("ca", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_7FW = new B.NumberSymbols("chr", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "USD");
  C.NumberSymbols_0VI = new B.NumberSymbols("cs", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "CZK");
  C.NumberSymbols_TD4 = new B.NumberSymbols("cy", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "GBP");
  ...
  C.NumberSymbols_slm = new B.NumberSymbols("de_AT", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "\xa4\xa0#,##0.00", "EUR");
  C.NumberSymbols_ECQ = new B.NumberSymbols("de_CH", ".", "'", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00;\xa4-#,##0.00", "CHF");
  C.NumberSymbols_Gbg = new B.NumberSymbols("el", ",", ".", "%", "0", "+", "-", "e", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_yfz = new B.NumberSymbols("en", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "USD");
  C.NumberSymbols_z2l = new B.NumberSymbols("en_AU", ".", ",", "%", "0", "+", "-", "e", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "AUD");
  C.NumberSymbols_FWV = new B.NumberSymbols("en_CA", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "CAD");
  C.NumberSymbols_ly0 = new B.NumberSymbols("en_GB", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "GBP");
  C.NumberSymbols_Ak1 = new B.NumberSymbols("en_IE", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "EUR");
  C.NumberSymbols_hyR = new B.NumberSymbols("en_IN", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "#E0", "#,##,##0%", "\xa4\xa0#,##,##0.00", "INR");
  C.NumberSymbols_c0u = new B.NumberSymbols("en_SG", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "SGD");
  C.NumberSymbols_8aB = new B.NumberSymbols("en_US", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "USD");
  C.NumberSymbols_CTe = new B.NumberSymbols("en_ZA", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "ZAR");
  C.NumberSymbols_wMy = new B.NumberSymbols("es", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_AyN = new B.NumberSymbols("es_419", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "\xa4#,##0.00", "MXN");
  C.NumberSymbols_Ucj = new B.NumberSymbols("es_ES", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_nyG = new B.NumberSymbols("es_MX", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "MXN");
  C.NumberSymbols_Oda = new B.NumberSymbols("es_US", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "\xa4#,##0.00", "USD");
  C.NumberSymbols_Cn5 = new B.NumberSymbols("et", ",", "\xa0", "%", "0", "+", "\u2212", "\xd710^", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_wEo = new B.NumberSymbols("eu", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "%\xa0#,##0", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_JrP = new B.NumberSymbols("fa", "\u066b", "\u066c", "\u066a", "\u06f0", "\u200e+\u200e", "\u200e\u2212", "\xd7\u06f1\u06f0^", "\u0609", "\u221e", "\u0646\u0627\u0639\u062f\u062f", "#,##0.###", "#E0", "#,##0%", "\u200e\xa4#,##0.00", "IRR");
  C.NumberSymbols_hfo = new B.NumberSymbols("fi", ",", "\xa0", "%", "0", "+", "\u2212", "E", "\u2030", "\u221e", "ep\xe4luku", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_c9P = new B.NumberSymbols("fil", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "PHP");
  C.NumberSymbols_rVS = new B.NumberSymbols("fr", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_IAZ = new B.NumberSymbols("fr_CA", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "CAD");
  C.NumberSymbols_ww8 = new B.NumberSymbols("ga", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "EUR");
  C.NumberSymbols_Svw = new B.NumberSymbols("gl", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "EUR");
  C.NumberSymbols_m8F = new B.NumberSymbols("gsw", ".", "\u2019", "%", "0", "+", "\u2212", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "CHF");
  C.NumberSymbols_9Is = new B.NumberSymbols("gu", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "[#E0]", "#,##,##0%", "\xa4#,##,##0.00", "INR");
  C.NumberSymbols_ww80 = new B.NumberSymbols("haw", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "USD");
  C.NumberSymbols_JAZ = new B.NumberSymbols("he", ".", ",", "%", "0", "\u200e+", "\u200e-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "ILS");
  C.NumberSymbols_mLh = new B.NumberSymbols("hi", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "[#E0]", "#,##,##0%", "\xa4#,##,##0.00", "INR");
  ...
  C.NumberSymbols_2UO = new B.NumberSymbols("hy", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "AMD");
  ...
  C.NumberSymbols_sBE = new B.NumberSymbols("is", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "ISK");
  C.NumberSymbols_o5K = new B.NumberSymbols("it", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_Cu4 = new B.NumberSymbols("iw", ".", ",", "%", "0", "\u200e+", "\u200e-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "ILS");
  C.NumberSymbols_sgl = new B.NumberSymbols("ja", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "JPY");
  C.NumberSymbols_KE7 = new B.NumberSymbols("ka", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "\u10d0\u10e0\xa0\u10d0\u10e0\u10d8\u10e1\xa0\u10e0\u10d8\u10ea\u10ee\u10d5\u10d8", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "GEL");
  C.NumberSymbols_e88 = new B.NumberSymbols("kk", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "KZT");
  C.NumberSymbols_Qqm = new B.NumberSymbols("km", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "KHR");
  C.NumberSymbols_wIv = new B.NumberSymbols("kn", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "INR");
  C.NumberSymbols_CrG = new B.NumberSymbols("ko", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "KRW");
  C.NumberSymbols_Vq4 = new B.NumberSymbols("ky", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "\u0441\u0430\u043d\xa0\u044d\u043c\u0435\u0441", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "KGS");
  C.NumberSymbols_uzY = new B.NumberSymbols("ln", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "CDF");
  C.NumberSymbols_3jH = new B.NumberSymbols("lo", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "\u0e9a\u0ecd\u0ec8\u200b\u0ec1\u0ea1\u0ec8\u0e99\u200b\u0ec2\u0e95\u200b\u0ec0\u0ea5\u0e81", "#,##0.###", "#", "#,##0%", "\xa4#,##0.00;\xa4-#,##0.00", "LAK");
  C.NumberSymbols_bl8 = new B.NumberSymbols("lt", ",", "\xa0", "%", "0", "+", "\u2212", "\xd710^", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_ASw = new B.NumberSymbols("lv", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "nav\xa0skaitlis", "#,##0.###", "#E0", "#,##0%", "#0.00\xa0\xa4", "EUR");
  C.NumberSymbols_uG6 = new B.NumberSymbols("mk", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "MKD");
  C.NumberSymbols_dAR = new B.NumberSymbols("ml", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "INR");
  C.NumberSymbols_gsm = new B.NumberSymbols("mn", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "MNT");
  C.NumberSymbols_ECn = new B.NumberSymbols("mr", ".", ",", "%", "\u0966", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "[#E0]", "#,##0%", "\xa4#,##0.00", "INR");
  C.NumberSymbols_s2l = new B.NumberSymbols("ms", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "MYR");
  C.NumberSymbols_Yzz = new B.NumberSymbols("mt", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "EUR");
  C.NumberSymbols_bpf = new B.NumberSymbols("my", ".", ",", "%", "\u1040", "+", "-", "E", "\u2030", "\u221e", "\u1002\u100f\u1014\u103a\u1038\u1019\u101f\u102f\u1010\u103a\u101e\u1031\u102c", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "MMK");
  C.NumberSymbols_EOZ = new B.NumberSymbols("nb", ",", "\xa0", "%", "0", "+", "\u2212", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "\xa4\xa0#,##0.00", "NOK");
  C.NumberSymbols_8aB0 = new B.NumberSymbols("ne", ".", ",", "%", "\u0966", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "NPR");
  C.NumberSymbols_IKz = new B.NumberSymbols("nl", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00;\xa4\xa0-#,##0.00", "EUR");
  C.NumberSymbols_0 = new B.NumberSymbols("no", ",", "\xa0", "%", "0", "+", "\u2212", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "\xa4\xa0#,##0.00", "NOK");
  C.NumberSymbols_UAT = new B.NumberSymbols("no_NO", ",", "\xa0", "%", "0", "+", "\u2212", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "\xa4\xa0#,##0.00", "NOK");
  C.NumberSymbols_iGE = new B.NumberSymbols("or", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "#E0", "#,##,##0%", "\xa4\xa0#,##,##0.00", "INR");
  C.NumberSymbols_B8J = new B.NumberSymbols("pa", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "[#E0]", "#,##,##0%", "\xa4#,##,##0.00", "INR");
  C.NumberSymbols_gkc = new B.NumberSymbols("pl", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "PLN");
  C.NumberSymbols_o7e = new B.NumberSymbols("pt", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "BRL");
  C.NumberSymbols_y6D = new B.NumberSymbols("pt_BR", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "BRL");
  ...
  C.NumberSymbols_TSr = new B.NumberSymbols("si", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#", "#,##0%", "\xa4#,##0.00", "LKR");
  C.NumberSymbols_4DV = new B.NumberSymbols("sk", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_knt = new B.NumberSymbols("sl", ",", ".", "%", "0", "+", "-", "e", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "EUR");
  C.NumberSymbols_v33 = new B.NumberSymbols("sq", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "ALL");
  C.NumberSymbols_TAS = new B.NumberSymbols("sr", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "RSD");
  C.NumberSymbols_jW0 = new B.NumberSymbols("sr_Latn", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "RSD");
  C.NumberSymbols_Ooj = new B.NumberSymbols("sv", ",", "\xa0", "%", "0", "+", "\u2212", "\xd710^", "\u2030", "\u221e", "\xa4\xa4\xa4", "#,##0.###", "#E0", "#,##0\xa0%", "#,##0.00\xa0\xa4", "SEK");
  C.NumberSymbols_a1A = new B.NumberSymbols("sw", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "TZS");
  C.NumberSymbols_ACG = new B.NumberSymbols("ta", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "#E0", "#,##,##0%", "\xa4\xa0#,##,##0.00", "INR");
  C.NumberSymbols_eD3 = new B.NumberSymbols("te", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##,##0.###", "#E0", "#,##0%", "\xa4#,##,##0.00", "INR");
  C.NumberSymbols_HYS = new B.NumberSymbols("th", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "THB");
  C.NumberSymbols_iTd = new B.NumberSymbols("tl", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "PHP");
  C.NumberSymbols_c9P0 = new B.NumberSymbols("tr", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "%#,##0", "#,##0.00\xa0\xa4", "TRY");
  C.NumberSymbols_bpf0 = new B.NumberSymbols("uk", ",", "\xa0", "%", "0", "+", "-", "\u0415", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "#,##0.00\xa0\xa4", "UAH");
  C.NumberSymbols_2jN = new B.NumberSymbols("ur", ".", ",", "%", "0", "\u200e+", "\u200e-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##,##0%", "\xa4\xa0#,##,##0.00", "PKR");
  C.NumberSymbols_qrh = new B.NumberSymbols("uz", ",", "\xa0", "%", "0", "+", "-", "E", "\u2030", "\u221e", "haqiqiy\xa0son\xa0emas", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "UZS");
  C.NumberSymbols_Q5O = new B.NumberSymbols("vi", ",", ".", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4\xa0#,##0.00", "VND");
  C.NumberSymbols_sSu = new B.NumberSymbols("zh", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "CNY");
  C.NumberSymbols_KMT = new B.NumberSymbols("zh_CN", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "CNY");
  C.NumberSymbols_mt1 = new B.NumberSymbols("zh_HK", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "\u975e\u6578\u503c", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "HKD");
  C.NumberSymbols_uwZ = new B.NumberSymbols("zh_TW", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "\u975e\u6578\u503c", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "TWD");
  C.NumberSymbols_lJS = new B.NumberSymbols("zu", ".", ",", "%", "0", "+", "-", "E", "\u2030", "\u221e", "NaN", "#,##0.###", "#E0", "#,##0%", "\xa4#,##0.00", "ZAR");
  C.Map_gM8Gl = new H.ConstantStringMap(107, {af: C.NumberSymbols_w0x, am: C.NumberSymbols_TV6, ar: C.NumberSymbols_xU4, az: C.NumberSymbols_WjS, be: C.NumberSymbols_zrt, bg: C.NumberSymbols_zDH, bn: C.NumberSymbols_Erq, br: C.NumberSymbols_YfA, bs: C.NumberSymbols_6Hv, ca: C.NumberSymbols_4QF, chr: C.NumberSymbols_7FW, cs: C.NumberSymbols_0VI, cy: C.NumberSymbols_TD4, da: C.NumberSymbols_4qm, de: C.NumberSymbols_Hpd, de_AT: C.NumberSymbols_slm, de_CH: C.NumberSymbols_ECQ, el: C.NumberSymbols_Gbg, en: C.NumberSymbols_yfz, en_AU: C.NumberSymbols_z2l, en_CA: C.NumberSymbols_FWV, en_GB: C.NumberSymbols_ly0, en_IE: C.NumberSymbols_Ak1, en_IN: C.NumberSymbols_hyR, en_SG: C.NumberSymbols_c0u, en_US: C.NumberSymbols_8aB, en_ZA: C.NumberSymbols_CTe, es: C.NumberSymbols_wMy, es_419: C.NumberSymbols_AyN, es_ES: C.NumberSymbols_Ucj, es_MX: C.NumberSymbols_nyG, es_US: C.NumberSymbols_Oda, et: C.NumberSymbols_Cn5, eu: C.NumberSymbols_wEo, fa: C.NumberSymbols_JrP, fi: C.NumberSymbols_hfo, fil: C.NumberSymbols_c9P, fr: C.NumberSymbols_rVS, fr_CA: C.NumberSymbols_IAZ, ga: C.NumberSymbols_ww8, gl: C.NumberSymbols_Svw, gsw: C.NumberSymbols_m8F, gu: C.NumberSymbols_9Is, haw: C.NumberSymbols_ww80, he: C.NumberSymbols_JAZ, hi: C.NumberSymbols_mLh, hr: C.NumberSymbols_aAj, hu: C.NumberSymbols_yXb, hy: C.NumberSymbols_2UO, id: C.NumberSymbols_wEo0, in: C.NumberSymbols_oGx, is: C.NumberSymbols_sBE, it: C.NumberSymbols_o5K, iw: C.NumberSymbols_Cu4, ja: C.NumberSymbols_sgl, ka: C.NumberSymbols_KE7, kk: C.NumberSymbols_e88, km: C.NumberSymbols_Qqm, kn: C.NumberSymbols_wIv, ko: C.NumberSymbols_CrG, ky: C.NumberSymbols_Vq4, ln: C.NumberSymbols_uzY, lo: C.NumberSymbols_3jH, lt: C.NumberSymbols_bl8, lv: C.NumberSymbols_ASw, mk: C.NumberSymbols_uG6, ml: C.NumberSymbols_dAR, mn: C.NumberSymbols_gsm, mr: C.NumberSymbols_ECn, ms: C.NumberSymbols_s2l, mt: C.NumberSymbols_Yzz, my: C.NumberSymbols_bpf, nb: C.NumberSymbols_EOZ, ne: C.NumberSymbols_8aB0, nl: C.NumberSymbols_IKz, no: C.NumberSymbols_0, no_NO: C.NumberSymbols_UAT, or: C.NumberSymbols_iGE, pa: C.NumberSymbols_B8J, pl: C.NumberSymbols_gkc, pt: C.NumberSymbols_o7e, pt_BR: C.NumberSymbols_y6D, pt_PT: C.NumberSymbols_XJC, ro: C.NumberSymbols_9a2, ru: C.NumberSymbols_RWw, si: C.NumberSymbols_TSr, sk: C.NumberSymbols_4DV, sl: C.NumberSymbols_knt, sq: C.NumberSymbols_v33, sr: C.NumberSymbols_TAS, sr_Latn: C.NumberSymbols_jW0, sv: C.NumberSymbols_Ooj, sw: C.NumberSymbols_a1A, ta: C.NumberSymbols_ACG, te: C.NumberSymbols_eD3, th: C.NumberSymbols_HYS, tl: C.NumberSymbols_iTd, tr: C.NumberSymbols_c9P0, uk: C.NumberSymbols_bpf0, ur: C.NumberSymbols_2jN, uz: C.NumberSymbols_qrh, vi: C.NumberSymbols_Q5O, zh: C.NumberSymbols_sSu, zh_CN: C.NumberSymbols_KMT, zh_HK: C.NumberSymbols_mt1, zh_TW: C.NumberSymbols_uwZ, zu: C.NumberSymbols_lJS}, C.List_gMT);
  ...
  $.agents = null;
  $.machines = null;
  $.numberFormatSymbols = C.Map_gM8Gl;
  $.axisWidth = 3;
  $.axisOffsetX = 25;
  $ = null;
  ...
  }, "TypeErrorDecoder_undefinedLiteralPropertyPattern", "BetaAgent_rGen", "$get$BetaAgent_rGen", function() {
    return P.Random_Random(null);
  }, "BetaAgent_rGen", "Machine_rGen", "$get$Machine_rGen", function() {
    return P.Random_Random(null);
  }, "Machine_rGen", "_AsyncRun__scheduleImmediateClosure", "$get$_AsyncRun__scheduleImmediateClosure", function() {
    return P._AsyncRun__initializeScheduleImmediate();
  }, "_AsyncRun__scheduleImmediateClosure", "_toStringVisiting", "$get$_toStringVisiting", function() {
    return [];
  }, "_toStringVisiting", "nfAlphaBeta", "$get$nfAlphaBeta", function() {
    return T.NumberFormat_NumberFormat("0.0", "en_US");
  }, "nfAlphaBeta", "nfExp", "$get$nfExp", function() {
    return T.NumberFormat_NumberFormat(".0000", "en_US");
  }, "nfExp", "currencyFractionDigits", "$get$currencyFractionDigits", function() {
    return P.LinkedHashMap__makeLiteral(["ADP", 0, "AFN", 0, "ALL", 0, "AMD", 0, "BHD", 3, "BIF", 0, "BYR", 0, "CAD", 2, "CHF", 2, "CLF", 4, "CLP", 0, "COP", 0, "CRC", 0, "CZK", 2, "DEFAULT", 2, "DJF", 0, "ESP", 0, "GNF", 0, "GYD", 0, "HUF", 2, "IDR", 0, "IQD", 0, "IRR", 0, "ISK", 0, "ITL", 0, "JOD", 3, "JPY", 0, "KMF", 0, "KPW", 0, "KRW", 0, "KWD", 3, "LAK", 0, "LBP", 0, "LUF", 0, "LYD", 3, "MGA", 0, "MGF", 0, "MMK", 0, "MNT", 0, "MRO", 0, "MUR", 0, "OMR", 3, "PKR", 0, "PYG", 0, "RSD", 0, "RWF", 0, "SLL", 0, "SOS", 0, "STD", 0, "SYP", 0, "TMM", 0, "TND", 3, "TRL", 0, "TWD", 2, "TZS", 0, "UGX", 0, "UYI", 0, "UZS", 0, "VND", 0, "VUV", 0, "XAF", 0, "XOF", 0, "XPF", 0, "YER", 0, "ZMK", 0, "ZWD", 0]);
  }, "currencyFractionDigits", "axisOffsetY", "$get$axisOffsetY", function() {
    return 17 + $.axisWidth;
  }, "axisOffsetY", "nf0", "$get$nf0", function() {
    return T.NumberFormat_NumberFormat(".0#", "en_US");
  }, "nf0", "nf1", "$get$nf1", function() {
    return T.NumberFormat_NumberFormat("0.0", "en_US");
  }, "nf1"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [W.Event]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, ret: P.num, args: [P.num, P.num]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.bool, args: [,]}];
